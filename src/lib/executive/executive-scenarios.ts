...
if (score >= 85 && riskLevel.toLowerCase() === "low") {
return "success";
}
...
timeImpact:
"Fastest route to contract award.",
riskImpact:
recommendedQuote.riskLevel,
boardView:
confidence >= 85
...
riskImpact:
"Low if scope remains unchanged.",
boardView:
"Recommended when leverage exists.",
},
...
: "info",
recommendation:
"Increase supplier participation before award.",
costImpact:
"May improve pricing competition.",
timeImpact:
"Delays procurement schedule.",
riskImpact:
"Lower selection risk.",
boardView:
"Use when competition is limited.",
},
...
costImpact:
budgetDelta < 0
? "Potential budget recovery."
: "Higher procurement cost.",
timeImpact:
"Longest schedule impact.",
riskImpact:
"Resets procurement process.",
boardView:
"Last resort.",
},
];
