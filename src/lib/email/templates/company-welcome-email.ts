...
<table width="100%" cellpadding="0" cellspacing="0" border="0" class="outer-padding" style="padding:34px 16px;background:#061426;">
<tr>
<td align="center">
<table width="640" cellpadding="0" cellspacing="0" border="0" class="email-container" style="max-width:640px;width:100%;background:#07111F;border-radius:30px;overflow:hidden;border:1px solid #1f3347;box-shadow:0 28px 90px rgba(0,0,0,0.38);">

<tr>
<td class="hero-padding" style="padding:42px 38px 34px;background:#07111F;border-bottom:1px solid #1f3347;">
<div class="brand-box" style="display:inline-block;background:#020617;border:1px solid #1f3347;border-radius:20px;padding:16px 20px;">
<p class="brand-title" style="margin:0;color:#ffffff;font-size:22px;font-weight:900;letter-spacing:-0.02em;">
Nexus Pavilion
</p>
...
<p style="margin:34px 0 0;color:#C8A646;font-size:12px;font-weight:900;letter-spacing:4px;text-transform:uppercase;">
Workspace Activated
</p>
...
<tr>
<td class="section-padding" style="padding:32px 38px 0;background:#07111F;">
...
<p style="margin:0;color:#94a3b8;font-size:12px;font-weight:900;letter-spacing:3px;text-transform:uppercase;">
Company Workspace
</p>

<h2 class="company-title" style="margin:14px 0 0;color:#ffffff;font-size:32px;line-height:1.2;font-weight:900;">
${safeCompanyName}
</h2>
...
<tr>
<td class="section-padding" style="padding:24px 38px 0;background:#07111F;">
<table width="100%" cellpadding="0" cellspacing="0" border="0" class="mobile-stack">
<tr>
<td width="50%" class="metric-cell" style="padding:7px;">
<div class="metric-card" style="border:1px solid #24364a;border-radius:18px;padding:18px;background:#061426;">
...
<tr>
<td style="padding:11px 0;color:#e5e7eb;font-size:15px;line-height:1.7;font-weight:700;">✓ Complete your company profile</td>
</tr>
<tr>
<td style="padding:11px 0;color:#e5e7eb;font-size:15px;line-height:1.7;font-weight:700;">✓ Invite procurement and leadership team members</td>
</tr>
<tr>
<td style="padding:11px 0;color:#e5e7eb;font-size:15px;line-height:1.7;font-weight:700;">✓ Prepare your first RFQ workflow</td>
</tr>
<tr>
<td style="padding:11px 0;color:#e5e7eb;font-size:15px;line-height:1.7;font-weight:700;">✓ Review supplier intelligence and reporting tools</td>
</tr>
</table>
</td>
</tr>
...
<tr>
<td class="section-padding" style="padding:32px 38px 0;background:#07111F;">
<table width="100%" cellpadding="0" cellspacing="0" border="0" class="button-wrap">
<tr>
<td class="button-wrap" style="padding:0 8px 0 0;">
<a href="${safeWorkspaceUrl}" class="button" style="display:inline-block;background:#C8A646;color:#061426;text-decoration:none;padding:17px 28px;border-radius:16px;font-weight:900;font-size:14px;letter-spacing:1px;text-transform:uppercase;">
Open Executive Workspace
</a>
</td>
<td class="button-wrap" style="padding:0 0 0 8px;">
<a href="${safeWorkspaceUrl}" class="button" style="display:inline-block;background:#0b1b2c;color:#ffffff;text-decoration:none;padding:17px 28px;border-radius:16px;font-weight:900;font-size:14px;border:1px solid #24364a;">
Review Dashboard
</a>
</td>
</tr>
...
<tr>
<td class="section-padding" style="padding:32px 38px 40px;background:#07111F;">
<p class="footer-text" style="margin:0;color:#64748b;font-size:13px;line-height:1.8;font-weight:600;">
...
<p class="footer-text" style="margin:18px 0 0;color:#475569;font-size:12px;line-height:1.7;">
