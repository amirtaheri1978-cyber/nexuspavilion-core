...
<Link
href="/notifications"
className="hidden rounded-full border border-[#C8A646]/25 bg-[#C8A646]/10 px-4 py-2 text-xs font-black uppercase tracking-wide text-[#F5D77B] transition hover:bg-[#C8A646]/15 sm:inline-flex"
>
Alerts
</Link>
...
<Link
href="/analytics"
className="hidden rounded-full border border-[#2CC4E8]/25 bg-[#2CC4E8]/10 px-4 py-2 text-xs font-black uppercase tracking-wide text-[#9BE8F8] transition hover:bg-[#2CC4E8]/15 md:inline-flex"
>
Boardroom
</Link>
