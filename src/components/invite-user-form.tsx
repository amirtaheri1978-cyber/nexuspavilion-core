...
value: "vendor",
label: "Vendor",
description: "External supplier or marketplace participant",
},
{
value: "buyer",
label: "Buyer",
description: "Procurement user who can support RFQ workflows",
},
{
value: "admin",
label: "Admin",
description: "Workspace leader with governance access",
},
];
